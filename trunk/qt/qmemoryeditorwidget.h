#ifndef QMEMORYVIEWWIDGET_H
#define QMEMORYVIEWWIDGET_H

#include <QtGui/QWidget>
#include "qtranslate.h"
#include "qmemorycursor.h"

class QMemoryEditorWidget : public QWidget
{
  Q_OBJECT

  public:
    QMemoryEditorWidget(QWidget *parent = 0);
    ~QMemoryEditorWidget();
  ...
  protected:
    ...
    std::vector< QRect > m_lineBBox;
    std::vector< QRect > m_columnBBox;
    QRect m_labelBBox;
    ...
    int m_rows;
    int m_width;
    QMemoryCursor m_cursor;
    int m_selection[2];
};

#endif // QMEMORYVIEWWIDGET_H
